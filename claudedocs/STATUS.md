...
| [FIX-154](4-changes/bug-fixes/FIX-154-currency-rule-pollutes-line-item-description.md) | currency rule pollutes line item description | 📋 規劃中（根因已確認並實機重現、修復方案待拍板） |
