...
| [FIX-150](4-changes/bug-fixes/FIX-150-nippon-charge-fields-lost-mapping-slot-contention.md) | nippon charge fields lost mapping slot contention | 🚧 進行中（第一層防護腳本已完成並驗證；主體設定修正待使用者決策） |
