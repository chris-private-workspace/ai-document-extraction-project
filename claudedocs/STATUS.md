...
| [CHANGE-113](4-changes/feature-changes/CHANGE-113-line-item-group-key-multi-shipment-invoice.md) | line item group key multi shipment invoice | 🚧 進行中（階段一 A1/A2/A3 + B、階段二全部完成，本地端到端 + 穩定度 + 燃油映射 2026-07-29 通過。待辦：A… |
