...
| [FIX-133](4-changes/bug-fixes/FIX-133-template-mapping-unique-constraint-never-enforced.md) | template mapping unique constraint never enforced | 🚧 進行中 —— 選項 A（盤點 + 判定）與 B-1（CEVA 重複組修正）+ Outbound 補齊已完成並驗證（2026-07-2… |
