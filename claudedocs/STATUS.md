...
| [FIX-131](4-changes/bug-fixes/FIX-131-company-detail-merge-entry-active-companies.md) | company detail merge entry active companies | 🚧 進行中（代碼實作完成 2026-07-22；type-check / lint / i18n:check 通過；待瀏覽器/部署驗證） |
