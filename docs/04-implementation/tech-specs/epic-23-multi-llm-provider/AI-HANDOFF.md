...
> **最後更新**：2026-07-09（規格 v0.4.0；Phase 0 spike 完成；**Story 23.1 step 1–3 完成**）｜ **維護**：每完成一個 Story 或重大決策後更新本檔。
